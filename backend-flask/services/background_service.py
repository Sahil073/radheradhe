...
Runs periodic tasks using Celery and schedule
"""
...
class BackgroundMonitor:
    ...
    def _check_battery_levels(self, sensor_data):
        ...
        for zone, data in sensor_data.items():
            ...
            # Low battery alert (throttled to once per hour)
    ...
    def _check_zone_status(self, sensor_data):
        ...
        for zone, config in Config.ZONES.items():
            if config["type"] == "critical":
                ...
                # If critical zone is OFF and battery is sufficient
    ...
    def run_optimization(self):
        ...
        try:
            ...
            # Throttle optimization to every 5 minutes minimum
    ...
    def retrain_models(self):
        ...
        try:
            # Get last 7 days of data for all zones
            historical_data = []
            ...
            if len(historical_data) > 100:  # Minimum data points
    ...
    def cleanup_old_data(self):
        ...
        try:
            ...
            # Keep only last 30 days of energy data
            cutoff_date = datetime.utcnow() - timedelta(days=30)
            cursor.execute("""
                DELETE FROM energy_data WHERE timestamp < %s
            """, (cutoff_date,))
